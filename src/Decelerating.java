public class Decelerating implements DroneState {
    /**
    ...
    public boolean arrived(Drone context) {
        if (context.getZoneToService() == null) {
            context.setCurrState(DroneStateID.LANDING);
        }
        else {
            context.setCurrState(DroneStateID.ARRIVED);
            /* TODO: send msg to scheduler to inform of arrival and await further instruction */
        }
        return true;
    }
